...
public class ServiceTypeBase implements Serializable {
  ...
  private static final boolean support_code_base =
      Boolean.getBoolean("com.gs.transport_protocol.lrmi.support-codebase");
  ...
  public void setCodebase(Class cls) {
    codebase =
        support_code_base ? RMIClassLoader.getClassAnnotation(cls) : null;
  }

  /**
   * Converts an array of ServiceTypeBase to an array of Class.  If a class
   * cannot be loaded, it is left as null.
   */
